...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
        <h4><i class="mdi-file-file-upload"></i>&nbsp;  Tambah Data Penyerahan</h4>
           <?php $this->load->view('staff/template/staff_subheadercontent'); ?>
            </br></br>
            <?php echo form_open('staff/proses_insertpenyerahan'); ?>
            <table>
              <tr>
                <td width="35%"> 
                ...
                <div class="col-sm-4 form-group">
                      ...
                      <input class="form-control datepicker-here" name="tgl_serah" data-language="en" data-date-format="dd/mm/yyyy" required>
                    </div>
              ...
              <tr>
                <td>
                    ...
                    <input class="form-control autocomppenyerahan" name="autocomplete_barang" id="auto1" type="text" required>
                    <input class="form-control autocomppenyerahan" name="stok_akhir" id="stok_akhir" type="hidden" required>
                    <input class="form-control autocomppenyerahan" name="kd_invent" id="kd_invent" type="hidden" required>
                    <input class="form-control autocomppenyerahan" name="kd_barang" id="kd_barang" type="hidden" required>
                  </div>
                     <div class="col-md-4 form-group">
              ...
              <tr>
                <td>
                    <div class="col-sm-4 form-group">
                      <label>Jumlah Barang yang diserahkan</label>
              ...
              <div class="col-sm-6">
              <button class="btn btn-addon btn-success" type="submit"><i class="fa fa-save"></i>Tambah Penyerahan</button>
