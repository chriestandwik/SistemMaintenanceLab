...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
        <h4><i class="mdi-action-launch"></i>&nbsp;  Tambah Transaksi Mutasi</h4>
         <?php $this->load->view('staff/template/staff_subheadercontent'); ?>
            </br></br>
            <?php echo form_open('staff/proses_insertmutasi'); ?>
            <table>
              <tr>
                <td> 
          ...
          <input class="form-control datepicker-here" name="tgl_pnmpt" data-language="en" data-date-format="dd/mm/yyyy" required>
              ...
              <div class="col-sm-6">
              <button class="btn btn-addon btn-success" type="submit"><i class="fa fa-save"></i>Tambah Transaksi Mutasi</button>
