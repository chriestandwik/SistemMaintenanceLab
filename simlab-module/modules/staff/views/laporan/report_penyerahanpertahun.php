...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
    <h4 >&nbsp; Laporan  Penyerahan Barang Per Tahun</h4>
    ...
    <p><strong>Tahun Penyerahan</strong></p>
      <select name="cbTahun" onchange="location=document.tahun.cbTahun.options[document.tahun.cbTahun.selectedIndex].value" class="form-control">
       <option value="<?php echo $baseurl; ?>/laporanpenerimaanpertahun/" <?php if($this->uri->segment(3)==""){ echo "selected";} ?>>Semua Tahun Penyerahan</option>
     <option value="<?php echo $baseurl; ?>/laporanpenerimaanpertahun/2017" <?php if($this->uri->segment(3)=="2017"){ echo "selected";} ?>>Penyerahan Tahun 2017</option>
    <option value="<?php echo $baseurl; ?>/laporanpenerimaanpertahun/2016" <?php if($this->uri->segment(3)=="2016"){ echo "selected";} ?>>Penyerahan Tahun 2016</option>
      </select>
      </div>
      </form>
</form>
        ...
        <div class="table-responsive">
            <table  class="table  table-bordered">
               ...
               <?php  if(empty($data)){ ?>
                    <tr>
                        <td colspan="10"><center><strong>Data Penyerahan Belum Terisi</strong> </center></td>
                    </tr>
                <?php } else { ?>
               <?php
                $no=0;
               ...
               <a href='<?php echo site_url('staff/cetakpenerimaan');?>' target="_blank">
