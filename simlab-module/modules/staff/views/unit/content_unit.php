...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
    <h4 ><i class="mdi-action-dns"></i>&nbsp;  Unit</h4>
        <?php $this->load->view('staff/template/staff_subheadercontent'); ?>
        <a href="tambahunit">
            &nbsp;&nbsp;<button class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Tambah Unit</button>
        </a>
        </p>
        <div class="table-responsive">
            <table align="center" class="table  table-bordered">
               ...
               <?php  if(empty($unit)){ ?>
                    <tr>
                        <td colspan="6"><center><strong>Data Unit Belum Terisi</strong> </center></td>
                    </tr>
                <?php } else { ?>
               <?php
                foreach($rows as $row){ ?>
