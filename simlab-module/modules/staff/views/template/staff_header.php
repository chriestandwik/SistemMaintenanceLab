...
<head>
    ...
    <?php $this->load->view('staff/template/staff_stylesheet'); ?>
</head>

<body>
    <div class="app blue-grey-50">
        <!-- aside -->
        <!-- sestelah fade ditambah folded jika ingin sidebar otomatis hide -->
                    ...
                    <div class="box-row">
                        <div class="box-cell scrollable hover">
                            <div class="box-inner">
                                ...
                                <?php $this->load->view('staff/template/staff_sidemenu'); ?>
