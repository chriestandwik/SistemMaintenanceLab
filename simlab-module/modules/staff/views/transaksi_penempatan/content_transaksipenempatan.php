...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
   <h4><i class="mdi-editor-format-list-bulleted"></i>&nbsp;  Transaksi Penempatan</h4>
         <?php $this->load->view('staff/template/staff_subheadercontent'); ?>
        <a href="tambahtransaksipenempatan">
            &nbsp;&nbsp;<button class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Tambah Transaksi Penempatan</button>
        </a>
        <p>
        <div class="table-responsive">
            <table align="center" class="table  table-bordered">
               ...
               <?php  if(empty($rows)){ ?>
                    <tr>
                        <td colspan="6"><center><strong>Data Transaksi Penempatan Belum Terisi</strong> </center></td>
                    </tr>
                <?php } else { ?>
               <?php
                foreach($rows as $row){ ?>
                <tr>
                    ...
                    <td><?php echo $row->tgl_penempatan; ?></td>
                    <td>
                    ...
                    <td><center>
                        <a href="<?php echo base_url(); ?>staff/updatepenempatan/<?php echo $row->kd_penempatan; ?>">
                            <button class="btn btn-sm btn-info"><i class="fa fa-pencil"></i>&nbsp;Ubah</button>
                        </a>
                    <?=anchor("staff/deletepenempatan/".$row->kd_penempatan,"
