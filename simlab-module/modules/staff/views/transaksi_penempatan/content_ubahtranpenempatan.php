...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
        <h4><i class="mdi-editor-format-list-bulleted"></i>&nbsp;  Ubah Transaksi Penempatan</h4>
                   <?php $this->load->view('staff/template/staff_subheadercontent'); ?>
            <?php echo form_open('staff/proses_updatepenempatan'); ?>
            <table>
              <tr>
                <td> 
                <div class="col-sm-6 form-group">
                      <label>Kode Penempatan</label>
                      <input class="form-control" name="kd_penempatn" ng-model="user.firstName" value="<?php echo $data->kd_penempatan; ?>" readonly>
                  </div>
                  </td>
              </tr>
            <tr>
          ...
          <input class="form-control datepicker-here" name="tgl_pnmpt" data-language="en" data-date-format="dd/mm/yyyy" value="<?php echo $data->tgl_penempatan; ?>" required>
               </div>
            </td>
            </tr>
              <tr>
              ...
              <div class="col-sm-6">
              <button class="btn btn-addon btn-success" type="submit"><i class="fa fa-save"></i>Ubah Transaksi Penempatan</button>
