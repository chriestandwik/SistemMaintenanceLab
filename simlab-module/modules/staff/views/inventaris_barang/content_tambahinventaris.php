             ...
             <table>
              ...
              <tr>
                ...
                ?>
                    ...
                    <input class="form-control autocompleteinv" name="kd_barang" id="kd_barang" type="hidden" value="<?php echo $kdbrg; ?>" required>
                    <input class="form-control autocompleteinv" name="kd_penerimaan" id="kd_penerimaan" type="hidden" value="<?php echo $kdpnrmaan; ?>" required>
                  </div>
                  </td>
              </tr>
              <tr>
                <td>
                    <div class="col-sm-3 form-group">
                      ...
                      <input class="form-control autocompleteinv" name="stok_awal" id="stokawal" value="<?php echo $stok_awal; ?>" type="text" readonly>
                     <input class="form-control autocompleteinv" name="stok_awal" id="stok_awal" value="<?php echo $stokawl; ?>" type="hidden" readonly>
                    </div>
                </td>
              </tr>
              <tr>
                <td>
                    <div class="col-sm-3 form-group">
                      ...
                      <input class="form-control autocompleteinv" name="stokakhir" id="stokakhir" value="<?php echo $stok_akhir; ?>" type="text" readonly>
                      <input class="form-control autocompleteinv" name="stok_akhir" id="stok_akhir" value="<?php echo $stokakh; ?>" type="hidden" readonly>
                    </div>
                </td>
              </tr>
              <tr>
