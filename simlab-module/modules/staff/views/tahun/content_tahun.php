...
<?php $this->load->view('staff/template/staff_headercontent'); ?>
    <h4><i class="mdi-av-my-library-books"></i>&nbsp;Tahun Ajaran</h4>
    <?php $this->load->view('staff/template/staff_subheadercontent'); ?>
        <a href="tambahtahun">
            &nbsp;&nbsp;<button class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Tambah Tahun Ajaran</button>
        </a>
        </p>
        <div class="table-responsive">
            <table align="center" class="table  table-bordered">
                ...
                <tr>
                    ...
                    <?php if(($row->status)==1){ $stat = "Aktif"; } else { $stat = "Tidak Aktif"; } ?>
                    <td><?php echo $stat; ?></td>
                    <td><center>
                        <a href="<?php echo base_url(); ?>staff/updatetahun/<?php echo $row->id_tahun; ?>">
                            <button class="btn btn-sm btn-info"><i class="fa fa-pencil"></i>&nbsp;Ubah</button>
                        </a>
                       <?=anchor("staff/deletetahun/".$row->id_tahun,"
                ...
                <?php }if(empty($rows)){?>
                    <tr>
                        <td colspan="6"><center><strong> Tahun Ajaran Belum Terisi</strong></center></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
